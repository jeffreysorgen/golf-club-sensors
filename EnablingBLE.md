...
We're starting from scratch with Android Studio in **Step Four: App Development, aka [_Enable Smartphone Response_](#step-four)** (which is entirely new to me at this point).
